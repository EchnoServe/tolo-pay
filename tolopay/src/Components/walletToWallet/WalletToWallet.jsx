        ...
        <div className="transfer">
          <form action="#" className="transfer-form">
            ...
            <Form form={form} name="control-hooks">
              ...
              <Form.Item
                noStyle
                shouldUpdate={(prevValues, currentValues) => prevValues.remark !== currentValues.remark}
              >
                {({ getFieldValue }) =>
                  getFieldValue('remark') === 'other' ? (
                    <Form.Item name="Remark" rules={[{ required: true }]} className='other'>
                      <Input />
                    </Form.Item>
                  ) : null
                }
      ...
      <div className="panel-container">
        <div className="panel ">
          <div className="content">
            <h3 style={{color: '#fff'}}>Wallet To Wallet Money Transfer</h3>
            <p>
